...
The wind speep raster was downloaded from @C3S2020. Given the resolution of the raster compared to the area of the studied lakes, we used the wind speed at 10 m from the surface at the coordinates of the sampling.
...
Our datasets contain CO2 concentration calculated from total inorganic carbon, following the methods suggested by @Sobek2003 (N112 survey) and @Aberg2014 (CBA survey).
