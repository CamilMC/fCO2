...
ggplot(norway)+geom_histogram(aes(x=log10(lake.area)))+facet_grid(rows = vars(survey))
ggplot(norway)+geom_histogram(aes(x=ECO2))+facet_grid(rows = vars(survey))
ggplot(nlss)+geom_histogram(aes(x=log10(lake.area)))
ggplot(nlss)+geom_histogram(aes(x= ECO2_toc))
```
