...
Method also used in @Couturier2022.
...
plot_grid(ggarrange(g1,g2),g3,nrow = 2, rel_heights = c(2,3), title = "test")
```
...
$k_{CO_2}$ has to be adjusted for temperature. @Crusius2003:
...
## Compare with @Weyhenmeyer2015

```{r compare-weyhenmeyer}
...
Surface of inland water from @SCB. All numbers converted to MtCO2/year

```{r tranvik-sweden}
inland.waters <- 4014169.92 * 1e4 # ha to m2, @SCB
mean.emissions.swe.toc <- nlss %>% filter(nation == "Sweden") %>% pull(ECO2_toc) %>% mean(na.rm = T) 
mean.emissions.swe.ta <- nlss %>% filter(nation == "Sweden" & pCO2_ta >= 0) %>% pull(ECO2_ta) %>% mean(na.rm = T) 

data.frame("ECO2 from TOC" = (inland.waters * mean.emissions.swe.toc /12.011 * 43.99* 30 * 6 * 1e-12), # from gC/day to gCO2/day to Mton CO2eq/year, assuming the rate if valid half of the year
           "ECO2 from TA" = (inland.waters * mean.emissions.swe.ta /12.011 * 43.99 * 30 * 6 * 1e-12), # from gC/year to gCO2/year to Mton CO2eq/year
           "Percent of NIR" = (inland.waters * mean.emissions.swe.toc /12.011 * 43.99 * 30 * 6 * 1e-12) / 36.9 * 100, #@SEPA2022
            "Sum ECO2 NLS" = sum(with(filter(nlss, nation == "Sweden"), ECO2_toc * lake.area*1e6 /12 * 43.99 * 30 * 6 * 1e-12), na.rm = T),
           "Total ECO2 from sum ECO2" = sum(with(filter(nlss, nation == "Sweden"), ECO2_toc * lake.area*1e6 /12.011 * 43.99 * 30 * 6 * 1e-12), na.rm = T)/sum(with(filter(nlss, nation == "Sweden"), lake.area*1e6))*inland.waters) %>% t()
...
mean.emissions.nor.toc <- nlss %>% filter(nation == "Norway") %>% pull(ECO2_toc) %>% mean(na.rm = T) 
mean.emissions.nor.ta <- nlss %>% filter(nation == "Norway") %>% pull(ECO2_ta) %>% mean(na.rm = T) 


data.frame("ECO2 from TOC" = (inland.waters * mean.emissions.nor.toc /12.011 * 43.99 * 30 * 6 * 1e-12), # from gC/day to gCO2/day to Mton CO2eq/year, assuming the rate if valid half of the year
           "ECO2 from TA" = (inland.waters * mean.emissions.nor.ta /12.011 * 43.99 * 30 * 6 * 1e-12), # from gC/year to gCO2/year to Mton CO2eq/year
           "Percent of NIR" = (inland.waters * mean.emissions.nor.toc /12.011 * 43.99 * 30 * 6 * 1e-12) / 38.7 * 100, # @Bjøness2020
            "Sum ECO2 NLS" = sum(with(filter(nlss, nation == "Norway"), ECO2_toc * lake.area*1e6 /12.011 * 43.99 * 30 * 6 * 1e-12), na.rm = T),
           "Total ECO2 from sum ECO2" = sum(with(filter(nlss, nation == "Norway"), ECO2_toc * lake.area*1e6 /12.011 * 43.99 * 30 * 6 * 1e-12), na.rm = T)/sum(with(filter(nlss, nation == "Norway"), lake.area*1e6))*inland.waters) %>% t()
...
mean.emissions.fin.toc <- nlss %>% filter(nation == "Finland") %>% pull(ECO2_toc) %>% mean(na.rm = T) 
mean.emissions.fin.ta <- nlss %>% filter(nation == "Finland") %>% pull(ECO2_ta) %>% mean(na.rm = T) 

data.frame("ECO2 from TOC" = (inland.waters * mean.emissions.fin.toc /12.011 * 43.99 * 30 * 6 * 1e-12), # from gC/day to gCO2/day to Mton CO2eq/year, assuming the rate if valid half of the year
           "ECO2 from TA" = (inland.waters * mean.emissions.fin.ta /12.011 * 43.99 * 30 * 6 * 1e-12), # from gC/year to gCO2/year to Mton CO2eq/year
           "Percent of NIR" = (inland.waters * mean.emissions.fin.toc /12.011 * 43.99 * 30 * 6 * 1e-12) / 58.4 * 100, # @Forsell2022
            "Sum ECO2 NLS" = sum(with(filter(nlss, nation == "Finland"), ECO2_toc * lake.area*1e6 /12.011 * 43.99 * 30 * 6 * 1e-12), na.rm = T),
           "Total ECO2 from sum ECO2" = sum(with(filter(nlss, nation == "Finland"), ECO2_toc * lake.area*1e6 /12.011 * 43.99 * 30 * 6 * 1e-12), na.rm = T)/sum(with(filter(nlss, nation == "Finland"), lake.area*1e6))*inland.waters) %>% t()
```
...
df2 <- subset(norway, survey == "CBA_2019" & ta_fCO2 >= 0)
