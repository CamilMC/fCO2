...
knitr::kable(summary.df, digits = 2, caption = "All pCO2") %>% 
  kable_styling(full_width= T, font_size = 14) %>%
  kableExtra::group_rows(group_label = "ECO2 from measured pCO2", start_row = 1, end_row = 2) %>%
  kableExtra::group_rows(group_label = "ECO2 computed with TA", start_row = 3, end_row = 7) %>%
  kableExtra::group_rows(group_label = "ECO2 computed with TOC", start_row = 8, end_row = 12) %>% 
